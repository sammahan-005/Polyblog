...
<body class="d-flex align-items-center justify-content-center vh-100 bg-light">
    ...
    <div class="container text-center p-5 shadow-lg rounded-4 bg-white border-top border-5 border-custom-primary" style="max-width: 600px;">
        ...
        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center mt-4">
            <a href="/inscription" class="btn btn-custom-primary btn-lg px-4">Inscription</a>
            <a href="/connexion" class="btn btn-outline-custom btn-lg px-4">Connexion</a>
        </div>
    </div>
